...
import br.unb.cic.rtgoretoprism.generator.pyhop.producer.RTPyhopProducer;
 ...
 * @author bertolini
 */
public class PyhopGenerationAction extends AbstractCodeGeneractionAction {
	private IWorkbenchWindow window;
	
	/**
	 * Creates a new KLCodeGenerationAction instance
	 */
	public PyhopGenerationAction() {
		super();
	}
	/**
        	...
        	/*	ps.busyCursorWhile( new IRunnableWithProgress() {
        		public void run( IProgressMonitor monitor )
					...
					try {*/
						...
						RTPyhopProducer producer = new RTPyhopProducer(selectedActors, selectedGoals, sourceFolder, targetFolder, false );
						producer.run();
