...
package br.unb.cic.rtgoretoprism.generator.pyhop.producer;
...
import br.unb.cic.rtgoretoprism.generator.pyhop.parser.PyhopRTParser;
import br.unb.cic.rtgoretoprism.generator.pyhop.writer.PrismWriter;
import br.unb.cic.rtgoretoprism.generator.pyhop.writer.PyhopWriter;
...
public class RTPyhopProducer {
	 ...
	 */
	public RTPyhopProducer(Set<Actor> allActors, Set<FHardGoal> allGoals, String in, String out, boolean parametric ) {
	...
	public void run() throws CodeGenerationException, IOException {
		...
		for( Actor a : allActors ) {
			...
			PyhopWriter writer = new PyhopWriter(ad, a);
			writer.start();
		}
	}
	...
	@SuppressWarnings("unchecked")
	private void storeRegexResults(String uid, String rtRegex) throws IOException { //Call for PyhopRTParser
		if(rtRegex != null){
			Object [] res = PyhopRTParser.parseRegex(uid, rtRegex + '\n');
